...
export type FooterDataQuery = { site: Maybe<(
    Pick<Site, 'buildTime'>
    & { siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'version'>> }
  )> };
...
export type BlogDataQuery = { markdownRemark: Maybe<(
    ...
    & { frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'tags' | 'image'>> }
  )> };

export type BlogHomeQueryVariables = {};


export type BlogHomeQuery = { allMarkdownRemark: (
