...
export type FooterDataQuery = {site: Maybe<Pick<Site, 'buildTime'> & {siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'version'>>}>};

export type HeaderDataQueryVariables = {};

export type HeaderDataQuery = {allSitePage: Pick<SitePageConnection, 'distinct'>; site: Maybe<{siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>>}>};

export type BlogDataQueryVariables = {
    slug: Scalars['String'];
};

export type BlogDataQuery = {markdownRemark: Maybe<Pick<MarkdownRemark, 'html'> & {frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'tags' | 'image'>>}>};

export type BlogHomeQueryVariables = {};

export type BlogHomeQuery = {
    allMarkdownRemark: Pick<MarkdownRemarkConnection, 'totalCount'> & {
        edges: Array<{node: Pick<MarkdownRemark, 'id' | 'excerpt'> & {frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date'>>; fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>>}}>;
    };
};
