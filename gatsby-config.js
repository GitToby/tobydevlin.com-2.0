...
module.exports = {
    siteMetadata: {
        title: 'TobyDevlin.com', version: packageJson.version, siteUrl: 'https://tobydevlin.com', socialLinks: {
        ...
        'gatsby-plugin-typescript', // will use the tsconfig.json to compile
        {
            ...
            fileName: './graphql-types.ts', documentPaths: ['./src/**/*.{ts,tsx}'], codegenDelay: 100
        }, {
        ...
        // DATA SOURCING PLUGINS
        {
            ...
            options: {
                name: 'images', path: `${__dirname}/content/img` // used for markdown pages, projects & blog posts
            }
        }, {
            resolve: 'gatsby-source-filesystem', // looks into the path below and provides the data in the graphQL server
            options: {
                name: 'blog-content', path: `${__dirname}/content/blog` // used for markdown pages, projects & blog posts
            }
        }, {
            resolve: 'gatsby-source-filesystem', // looks into the path below and provides the data in the graphQL server
            options: {
                name: 'static-content', path: `${__dirname}/static` // used for markdown pages, projects & blog posts
            }
        },
        ...
        'gatsby-plugin-react-helmet', // add SEO Headers ans such
        {
            ...
            resolve: `gatsby-plugin-hotjar`, options: {
